...
fig, ax = pypl.subplots(figsize=[5.41+1.08, 3.72+0.74])
...
window = pygame.display.set_mode((541+108, 372+72), DOUBLEBUF)
...
for i in range(1000):
    x_restriction = 560
    x_restriction_left = 100
    y_restriction = 370
    y_restriction_bottom = 70
                ...
                for i in previous_neighbours_list:
                    ...
                    if (
                        ...
                        if (check_obstacle(obstacles_coordinates_new, p0_x, p0_y)) == 0:
                            pygame.draw.circle(surf, color, (p0_x, p0_y), 20,1)
                    ...
                    if (
                        ...
                        if (check_obstacle(obstacles_coordinates_new, p1_x, p1_y)) == 0:
                            pygame.draw.circle(surf, color, (p1_x, p1_y), 20,1)
                    ...
                    if (
                        ...
                        if (check_obstacle(obstacles_coordinates_new, p2_x, p2_y)) == 0:
                            pygame.draw.circle(surf, color, (p2_x, p2_y), 20,1)
                    ...
                    if (
                        ...
                        if (check_obstacle(obstacles_coordinates_new, p3_x, p3_y)) == 0:
                            pygame.draw.circle(surf, color, (p3_x, p3_y), 20,1)
                    ...
                    if (
                        ...
                        if (check_obstacle(obstacles_coordinates_new, p4_x, p4_y)) == 0:
                            pygame.draw.circle(surf, color, (p4_x, p4_y), 20,1)
                    ...
                    if (
                        ...
                        if (check_obstacle(obstacles_coordinates_new, p5_x, p5_y)) == 0:
                            pygame.draw.circle(surf, color, (p5_x, p5_y), 20,1)
                    ...
                    if (
                        ...
                        if (check_obstacle(obstacles_coordinates_new, p6_x, p6_y)) == 0:
                            pygame.draw.circle(surf, color, (p6_x, p6_y), 20,1)
                    ...
                    if (
                        ...
                        if (check_obstacle(obstacles_coordinates_new, p8_x, p8_y)) == 0:
                            pygame.draw.circle(surf, color, (p8_x, p8_y), 20,1)
...
start_coordinates1 = []
new_f = f.copy()
new_startX = x_start[0] + 83
new_startY = y_start[0] - 214
start_coordinates1.append((new_startX, new_startY))
closest_points.append((new_startX, new_startY))
minimum = 600

generated_path = search_path(closest_points, minimum, new_f, 400)
optimal = search_min_distances(generated_path, [[x_draw_goal, y_draw_goal]])
draw_path(start_coordinates1, optimal)


#Displaying the AR goal marker
goal_picturue = pygame.image.load('../marker_images/marker_497.png').convert_alpha()
goal_picturue= pygame.transform.scale(goal_picturue, (30, 30))


screen.blit(surf, (0, 0))
screen.blit(goal_picturue, (x_draw_goal-10,y_draw_goal-10))
pygame.display.flip()
