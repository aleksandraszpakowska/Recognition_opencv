...
# goal_coordianets = [(520, 400)]
# center_list = [(11, 15), (11, 416), (593, 416), (593, 15)]
# obstacles_coordinates = [(189, 315), (300, 222)]
...
#for i in range(600):
    ...
    x_restriction = x_borders[2]-10
    x_restriction_left = 0
    y_restriction = y_borders[2]-10
    y_restriction_bottom = 0
...
# with open('path_coords.txt', 'w') as file:
#     for x, y in path_smooth:
#         file.write('{} {}\n'.format(x, y))


color1=(100,255,0)
#draw_path(start_coordinates1, optimal,color=(100,0,255))
