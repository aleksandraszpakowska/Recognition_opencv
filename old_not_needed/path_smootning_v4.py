...
generated_path = search_path(closest_points, minimum, new_f, 1000)
...
color1 = (0,255,100)
color2 = (255,0,100)
draw_path(start_coordinates1, optimal,color2)
...
#
# detected markers: [[<Marker id=497 center=(469, 423)>, <Marker id=1751 center=(37, 406)>, <Marker id=733 center=(354, 370)>, <Marker id=4076 center=(130, 235)>, <Marker id=2165 center=(340, 201)>, <Marker id=1281 center=(476, 52)>, <Marker id=1184 center=(27, 50)>]]
# obstacles: [(354, 370), (340, 201)]
# goal: [(469, 423)]
# coordination list:  [(37, 406), (130, 235), (476, 52), (27, 50)]
# items list: [<Marker id=497 center=(469, 423)>, <Marker id=1751 center=(37, 406)>, <Marker id=733 center=(354, 370)>, <Marker id=4076 center=(130, 235)>, <Marker id=2165 center=(340, 201)>, <Marker id=1281 center=(476, 52)>, <Marker id=1184 center=(27, 50)>]
